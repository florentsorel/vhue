...
var __vue_render__$3 = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M26,16 L6,16 C3.791,16 2,17.791 2,20 L2,22 C2,22.553 2.447,23 3,23 L4,23 L4,24 C4,25.104 4.896,26 6,26 C7.104,26 8,25.104 8,24 L8,23 L24,23 L24,24 C24,25.104 24.896,26 26,26 C27.104,26 28,25.104 28,24 L28,23 L29,23 C29.553,23 30,22.553 30,22 L30,20 C30,17.791 28.209,16 26,16 M9,10 L14,10 C14.553,10 15,10.447 15,11 C15,11.553 14.553,12 14,12 L9,12 C8.447,12 8,11.553 8,11 C8,10.447 8.447,10 9,10 M18,10 L23,10 C23.553,10 24,10.447 24,11 C24,11.553 23.553,12 23,12 L18,12 C17.447,12 17,11.553 17,11 C17,10.447 17.447,10 18,10 M7.009,14 L24.991,14 C25.549,14 26,13.549 26,12.991 L26,8 C26,6.896 25.104,6 24,6 L8,6 C6.896,6 6,6.896 6,8 L6,12.991 C6,13.549 6.451,14 7.009,14"
    }
  })])])]);
};
...
var __vue_render__$6 = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M29,5 C29.55,5 30,5.45 30,6 L30,17 L2,17 L2,6 C2,5.45 2.45,5 3,5 L29,5 Z M2,20 L2,19 L30,19 L30,20 C30,20.55 29.55,21 29,21 L17,21 L17,25 L19,25 C19.553,25 20,25.447 20,26 C20,26.553 19.553,27 19,27 L13,27 C12.447,27 12,26.553 12,26 C12,25.447 12.447,25 13,25 L15,25 L15,21 L3,21 C2.45,21 2,20.55 2,20 Z"
    }
  })])])]);
};
...
var __vue_render__$f = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M23.5,7 C24.328,7 25,7.672 25,8.5 C25,9.328 24.328,10 23.5,10 L8.5,10 C7.672,10 7,9.328 7,8.5 C7,7.672 7.672,7 8.5,7 L14.277,7 C14.105,6.705 14,6.366 14,6 C14,4.896 14.896,4 16,4 C17.104,4 18,4.896 18,6 C18,6.366 17.895,6.705 17.723,7 L23.5,7 Z M26,12 C27.104,12 28,12.896 28,14 C28,15.104 27.104,16 26,16 L25,16 L25,25.879 C25,27.051 24.05,28 22.879,28 L9.121,28 C7.95,28 7,27.051 7,25.879 L7,16 L6,16 C4.896,16 4,15.104 4,14 C4,12.896 4.896,12 6,12 L9.121,12 L22.879,12 L26,12 Z"
    }
  })])])]);
};
...
var __vue_render__$h = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M28,13 C29.104,13 30,13.896 30,15 L30,17.064 L30,19.064 L30,21.064 C30,21.581 29.581,22 29.064,22 L28,22 L28,23 C28,24.104 27.104,25 26,25 C24.896,25 24,24.104 24,23 L24,22 L8,22 L8,23 C8,24.104 7.104,25 6,25 C4.896,25 4,24.104 4,23 L4,22 L2.936,22 C2.419,22 2,21.581 2,21.064 L2,19.064 L2,17.064 L2,15 C2,13.896 2.896,13 4,13 C5.104,13 6,13.896 6,15 L6,16.064 L6,17 L26,17 L26,16.064 L26,15 C26,13.896 26.896,13 28,13 Z M8,15 C8,12.791 6.209,11 4,11 L4,9 C4,7.896 4.896,7 6,7 L26,7 C27.104,7 28,7.896 28,9 L28,11 C25.791,11 24,12.791 24,15 L8,15 Z"
    }
  })])])]);
};
...
var __vue_render__$i = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M24,17 C27.313,17 30,17.687 30,21 C30,21.553 29.553,22 29,22 L28,22 L28,23 C28,24.104 27.104,25 26,25 C24.896,25 24,24.104 24,23 L24,22 L8,22 L8,23 C8,24.104 7.104,25 6,25 C4.896,25 4,24.104 4,23 L4,22 L3.232,22 L3,22 C2.447,22 2,21.553 2,21 C2,20.947 2.014,20.897 2.016,20.845 C2.014,20.817 2,20.795 2,20.768 L2,13.907 C2,12.858 2.858,12 3.907,12 L4.093,12 C5.142,12 6,12.858 6,13.907 L6,17 L24,17 Z M4.093,10 L3.907,10 C3.309,10 2.508,10.194 2,10.436 C2.795,7.357 5.801,5 10.48,5 C14.961,5 17.77,7.117 19,10 L24.349,10 C26.365,10 28,11.635 28,13.651 L28,14.087 C28,14.592 27.592,15 27.087,15 L8,15 L8,13.907 C8,11.753 6.247,10 4.093,10 Z"
    }
  })])])]);
};
...
var __vue_render__$t = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M27,28 L11.414,28 L28,11.414 L28,27 C28,27.553 27.553,28 27,28 Z M23,4 L28,4 L28,8.586 L8.586,28 L4,28 L4,23 C4,22.447 4.447,22 5,22 L10,22 L10,17 C10,16.447 10.447,16 11,16 L16,16 L16,11 C16,10.447 16.447,10 17,10 L22,10 L22,5 C22,4.447 22.447,4 23,4 Z"
    }
  })])])]);
};
...
var __vue_render__$u = function () {
  ...
  return _c('svg', {
    ...
    attrs: {
      "d": "M5,26 L5,11 L27,11 L27,26 C27,26.553 26.553,27 26,27 L6,27 C5.447,27 5,26.553 5,26 Z M12,15 C11.447,15 11,15.447 11,16 C11,16.553 11.447,17 12,17 L20,17 C20.553,17 21,16.553 21,16 C21,15.447 20.553,15 20,15 L12,15 Z M26,5 C26.553,5 27,5.447 27,6 L27,9 L5,9 L5,6 C5,5.447 5.447,5 6,5 L26,5 Z"
    }
  })])])]);
};
...
const choices = ['attic', 'balcony', 'bathroom', 'bedroom', 'carpot', 'closet', 'computer', 'dining', 'driveway', 'frontdoor', 'garage', 'guestroom', 'gym', 'hallway', 'kidsbedroom', 'kitchen', 'laundryroom', 'living', 'lounge', 'mancave', 'nursery', 'office', 'other', 'outdoor', 'outdoor-socialtime', 'pool', 'porch', 'recreation', 'socialtime', 'staircase', 'storage', 'studio', 'terrace', 'toilet'];
...
var __vue_render__$y = function () {
  ...
  return _c('div', {
    staticClass: "hue",
    style: {
      backgroundColor: _vm.isChecked ? _vm.color : 'rgb(66, 66, 66)'
    }
  }, [_c('div', {
    staticClass: "hue-content"
  }, [_c('div', {
    staticClass: "hue-content-icon"
  }, [_c(_vm.Icon, {
    tag: "component",
    attrs: {
    ...
    staticClass: "hue-content-toggle-checkbox",
    attrs: {
      "type": "checkbox",
      "value": "1"
    },
    ...
    staticClass: "hue-content-toggle-label",
    style: {
      backgroundColor: _vm.isChecked ? _vm.Color(_vm.color).darken(0.2) : '#7B7B7B'
    },
    on: {
...
const __vue_inject_styles__$y = function (inject) {
  if (!inject) return;
  inject("data-v-03299fb5_0", {
    source: ".hue[data-v-03299fb5]{font-family:Arial,Helvetica Neue,Helvetica,sans-serif;border-radius:10px;padding:20px;max-width:300px;min-width:280px;position:relative;transition:all .3s ease}.hue-content[data-v-03299fb5]{display:flex;min-height:40px}.hue-content-icon[data-v-03299fb5]{align-self:center;flex:0 0 32px;height:32px;max-width:32px}.hue-content-text[data-v-03299fb5]{align-self:center;margin:0 16px;width:10rem}.hue-content-text-name[data-v-03299fb5]{flex:1 0 auto;font-weight:700;font-size:16px;line-height:24px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}.hue-content-toggle[data-v-03299fb5]{align-self:center;margin-left:auto}.hue-content-toggle-checkbox[data-v-03299fb5]{height:0;width:0;display:none}.hue-content-toggle-checkbox:checked+.hue-content-toggle-label[data-v-03299fb5]:after{background:#fff;left:100%;transform:translate(-100%,-50%)}.hue-content-toggle-label[data-v-03299fb5]{cursor:pointer;text-indent:-9999px;width:40px;height:18px;display:block;border-radius:100px;position:relative}.hue-content-toggle-label[data-v-03299fb5]:active:after{width:25px}.hue-content-toggle-label[data-v-03299fb5]:after{content:\"\";position:absolute;top:50%;left:0;width:22px;height:22px;background:#b9b9b9;border-radius:90px;transition:.3s;transform:translateY(-50%)}",
    map: undefined,
    media: undefined
  });
};
...
const __vue_scope_id__$y = "data-v-03299fb5";
/* module identifier */
...
export default __vue_component__$y;
